...
export const content: Record<Locale, PageContent> = {
  fr: {
    ...
    difference: {
      ...
      closing: "Nous ne promettons pas de solution miracle. Nous engageons notre responsabilité sur la durée — et sur le fait que la solution soit toujours opérationnelle dans un an.",
    },
    expertise: {
  ...
  en: {
    ...
    difference: {
      ...
      closing: "We do not promise a miracle solution. We commit to accountability over time — and to the solution remaining operational a year on.",
    },
    expertise: {
      founderName: "Moursala Soudjay",
      founderRole: "Founder",
    ...
    contact: {
      ...
      p: "A few lines suffice: the nature of the constraint encountered, and the outcome sought. You will receive a substantiated opinion on the first action to undertake — without contractual commitment, including where the response does not constitute a mission for Yakini.",
