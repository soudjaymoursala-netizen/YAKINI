...
export const content: Record<Locale, PageContent> = {
  fr: {
    ...
    hero: {
      ...
      h1: "Yakini vous accompagne pour fiabiliser vos opérations et simplifier ce qui doit l'être.",
      lede:
  ...
  en: {
    ...
    hero: {
      ...
      h1: "Yakini supports you in strengthening your operations and simplifying what should be simple.",
      lede:
