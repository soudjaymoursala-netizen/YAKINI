      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            founder: {
              "@type": "Person",
              name: "Moursala Soudjay",
              jobTitle: lang === "fr" ? "Fondateur" : "Founder",
              knowsAbout: [
                "Quality Management",
                "Equipment & Computer System Validation (CQV/CSV)",
                "Lean Management",
      ...
      <main>
        ...
        <section id="contenu" className="on-navy bg-navy py-20 text-on-navy sm:py-28">
          <div className="wrap grid items-center gap-14 md:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <h1 className="mt-4 text-[clamp(34px,5vw,56px)] leading-[1.06] tracking-[-0.02em] text-white">
                {c.hero.h1}
              </h1>
        ...
        <section id="secteurs" className="bg-cream-alt py-20 sm:py-24">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-navy">{c.secteurs.h2}</h2>
        ...
        <section id="origine" className="reveal bg-cream py-20 sm:py-24">
          <div className="wrap">
            ...
            <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-navy">{c.apropos.h2}</h2>
        ...
        <section id="solutions" className="bg-cream-alt py-20 sm:py-24">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-navy">
        ...
        <section id="expertise" className="on-navy bg-navy-deep py-20 text-on-navy sm:py-24">
          <div className="wrap grid gap-12 md:grid-cols-[0.85fr_1.15fr]">
            ...
            <div className="reveal">
              ...
              <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-white">{c.expertise.h2}</h2>
        ...
        <section id="questions" className="bg-cream py-20 sm:py-24">
          <div className="wrap">
            <div className="reveal">
              ...
              <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-navy">{c.faq.h2}</h2>
            </div>
        ...
        <section id="contact" className="on-navy bg-navy py-20 text-center text-on-navy sm:py-24">
          <div className="wrap">
            ...
            <h2 className="mt-3 text-[clamp(28px,3.8vw,44px)] tracking-[-0.015em] text-white">{c.contact.h2}</h2>
